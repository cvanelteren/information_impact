...
#                bint parallel = True, \
#                dict pulse = {}, str updateType= 'source'):
#     '''
...
#                             updateType= mode, repeats = repeats, \
...
#         conditions = (nudgeType == 'constant' and delta >= half,\
#                       nudgeType == 'pulse')
#         if nudgeType == 'pulse':
#           _pulse = {}
#         elif nudgeType == 'constant' and delta == half:
#         # if any(conditions):
#           _pulse = {}
#
